...
4. **Validating and verifying the PR:** 
   ...
   **If you are a contributor, consider these points as prerequisites before your PR can be reviewed. Please ask for help if needed, either by making a comment on the PR or via a _GitHub discussion_.**
   ...
   - If the PR has been reviewed and the reviewer left some comments, address them and clearly document what you did. Either write a proper response like "addressed in commit _XYZ_" or explain why you did what you did. A mere "thumbs up" is not enough. The reviewer will mark the conversation as "resolved" once he/she is happy with the result.
